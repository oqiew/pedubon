...
class Person_historys extends React.Component {
    ...
    componentDidMount() {
        ...
        this.unsubscribe = this.tbPersonHistorys.onSnapshot(this.onCollectionUpdate);
        console.log(this.props.match.params.Pname)
    }
    ...
    onSubmit = e => {
        ...
        if (edit_ID !== '') {
            this.tbPersonHistorys.doc(edit_ID).update({
        ...
        return (
            <div>
                ...
                <div className='main_component'>
                    <center>
                        <h2><strong>ประวัติบุคคลที่น่าสนใจ : {this.props.match.params.Pname}</strong> </h2>
                        <hr></hr>
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <Link to={'/persons'} className="btn btn-danger">กลับ</Link>
                            <br></br>{showStatus}
                        </form>
...
export default Person_historys;
